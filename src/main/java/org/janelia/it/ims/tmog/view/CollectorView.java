...
public class CollectorView
     ...
     */
    private static final Logger LOG = LogManager.getLogger(CollectorView.class);
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        dataPanel.add(dataTableScrollPane, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
                                                               ...
                                                               GridConstraints.SIZEPOLICY_CAN_SHRINK |
                                                               GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        dataTableScrollPane.setBorder(BorderFactory.createTitledBorder(BorderFactory.createRaisedBevelBorder(), null, TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
