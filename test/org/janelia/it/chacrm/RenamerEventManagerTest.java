...
/**
 * Tests the RenamerEventManager class.
 *
 * @author Eric Trautman
 */
public class RenamerEventManagerTest extends TestCase {
     ...
     */
    public RenamerEventManagerTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(RenamerEventManagerTest.class);
    }
    ...
    public void testGetImageLocation() throws Exception {
        ...
        for (String[] data : testData) {
            ...
            ImageLocation imageLocaton =
                    RenamerEventManager.getImageLocation(fileName, pattern);
